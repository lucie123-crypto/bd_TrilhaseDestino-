-- Criação do Arquivo
create database TrilhaseDestino; --Acessando Arquivo
use TrilhaseDestino;
-- Criando tabelas
...
data_reserva DATE,
status VARCHAR(20),
FOREIGN KEY (id_cliente) REFERENCES Clientes (id_cliente), FOREIGN KEY (id_pacote) REFERENCES Pacotes (id_pacote)
);
